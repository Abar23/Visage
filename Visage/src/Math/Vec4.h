	...
	namespace Math
	{
		...
		public:
			union
			{
				...
				Swizzle<Vec2, T, 2, 0, 3> xw;
				Swizzle<Vec2, T, 2, 1, 0> yx;
				Swizzle<Vec2, T, 2, 1, 1> yy;
				Swizzle<Vec2, T, 2, 1, 2> yz;
				Swizzle<Vec2, T, 2, 1, 3> yw;
				Swizzle<Vec2, T, 2, 2, 0> zx;
				Swizzle<Vec2, T, 2, 2, 1> zy;
				Swizzle<Vec2, T, 2, 2, 2> zz;
				Swizzle<Vec2, T, 2, 2, 3> zw;
				Swizzle<Vec2, T, 2, 3, 0> wx;
				Swizzle<Vec2, T, 2, 3, 1> wy;
				Swizzle<Vec2, T, 2, 3, 2> wz;
				Swizzle<Vec2, T, 2, 3, 3> ww;

				Swizzle<Vec3, T, 3, 0, 0, 0> xxx;
				Swizzle<Vec3, T, 3, 0, 0, 1> xxy;
				Swizzle<Vec3, T, 3, 0, 0, 2> xxz;
				Swizzle<Vec3, T, 3, 0, 0, 3> xxw;
				Swizzle<Vec3, T, 3, 0, 1, 0> xyx;
				Swizzle<Vec3, T, 3, 0, 1, 1> xyy;
				Swizzle<Vec3, T, 3, 0, 1, 2> xyz;
				Swizzle<Vec3, T, 3, 0, 1, 3> xyw;
				Swizzle<Vec3, T, 3, 0, 2, 0> xzx;
				Swizzle<Vec3, T, 3, 0, 2, 1> xzy;
				Swizzle<Vec3, T, 3, 0, 2, 2> xzz;
				Swizzle<Vec3, T, 3, 0, 2, 3> xzw;
				Swizzle<Vec3, T, 3, 0, 3, 0> xwx;
				Swizzle<Vec3, T, 3, 0, 3, 1> xwy;
				Swizzle<Vec3, T, 3, 0, 3, 2> xwz;
				Swizzle<Vec3, T, 3, 0, 3, 3> xww;
				Swizzle<Vec3, T, 3, 1, 0, 0> yxx;
				Swizzle<Vec3, T, 3, 1, 0, 1> yxy;
				Swizzle<Vec3, T, 3, 1, 0, 2> yxz;
				Swizzle<Vec3, T, 3, 1, 0, 3> yxw;
				Swizzle<Vec3, T, 3, 1, 1, 0> yyx;
				Swizzle<Vec3, T, 3, 1, 1, 1> yyy;
				Swizzle<Vec3, T, 3, 1, 1, 2> yyz;
				Swizzle<Vec3, T, 3, 1, 1, 3> yyw;
				Swizzle<Vec3, T, 3, 1, 2, 0> yzx;
				Swizzle<Vec3, T, 3, 1, 2, 1> yzy;
				Swizzle<Vec3, T, 3, 1, 2, 2> yzz;
				Swizzle<Vec3, T, 3, 1, 2, 3> yzw;
				Swizzle<Vec3, T, 3, 1, 3, 0> ywx;
				Swizzle<Vec3, T, 3, 1, 3, 1> ywy;
				Swizzle<Vec3, T, 3, 1, 3, 2> ywz;
				Swizzle<Vec3, T, 3, 1, 3, 3> yww;
				Swizzle<Vec3, T, 3, 2, 0, 0> zxx;
				Swizzle<Vec3, T, 3, 2, 0, 1> zxy;
				Swizzle<Vec3, T, 3, 2, 0, 2> zxz;
				Swizzle<Vec3, T, 3, 2, 0, 3> zxw;
				Swizzle<Vec3, T, 3, 2, 1, 0> zyx;
				Swizzle<Vec3, T, 3, 2, 1, 1> zyy;
				Swizzle<Vec3, T, 3, 2, 1, 2> zyz;
				Swizzle<Vec3, T, 3, 2, 1, 3> zyw;
				Swizzle<Vec3, T, 3, 2, 2, 0> zzx;
				Swizzle<Vec3, T, 3, 2, 2, 1> zzy;
				Swizzle<Vec3, T, 3, 2, 2, 2> zzz;
				Swizzle<Vec3, T, 3, 2, 2, 3> zzw;
				Swizzle<Vec3, T, 3, 2, 3, 0> zwx;
				Swizzle<Vec3, T, 3, 2, 3, 1> zwy;
				Swizzle<Vec3, T, 3, 2, 3, 2> zwz;
				Swizzle<Vec3, T, 3, 2, 3, 3> zww;
				Swizzle<Vec3, T, 3, 3, 0, 0> wxx;
				Swizzle<Vec3, T, 3, 3, 0, 1> wxy;
				Swizzle<Vec3, T, 3, 3, 0, 2> wxz;
				Swizzle<Vec3, T, 3, 3, 0, 3> wxw;
				Swizzle<Vec3, T, 3, 3, 1, 0> wyx;
				Swizzle<Vec3, T, 3, 3, 1, 1> wyy;
				Swizzle<Vec3, T, 3, 3, 1, 2> wyz;
				Swizzle<Vec3, T, 3, 3, 1, 3> wyw;
				Swizzle<Vec3, T, 3, 3, 2, 0> wzx;
				Swizzle<Vec3, T, 3, 3, 2, 1> wzy;
				Swizzle<Vec3, T, 3, 3, 2, 2> wzz;
				Swizzle<Vec3, T, 3, 3, 2, 3> wzw;
				Swizzle<Vec3, T, 3, 3, 3, 0> wwx;
				Swizzle<Vec3, T, 3, 3, 3, 1> wwy;
				Swizzle<Vec3, T, 3, 3, 3, 2> wwz;
				Swizzle<Vec3, T, 3, 3, 3, 3> www;
